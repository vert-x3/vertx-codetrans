...
public class DataObjectTest extends ConversionTestBase {
  ...
  public void testSetFromConstructor() throws Exception {
    ...
    Assert.assertEquals(new JsonObject().put("host", "localhost").put("port", 8080), unwrapJsonObject((ScriptObject) o));
    o = null;
  ...
  public void testNested() throws Exception {
    ...
    Assert.assertEquals(new JsonObject().put("keyStoreOptions", new JsonObject().put("path", "/mystore.jks").put("password", "secret")), unwrapJsonObject((ScriptObject) o));
    o = null;
  ...
  public void testAdd() throws Exception {
    ...
    HttpServerOptions actual = new HttpServerOptions(unwrapJsonObject((ScriptObject) o));
